...
var oDepCal = new Calendar({
		...
		range:		   {mindate: "1980-09-01", maxdate: "2030-12-31"},	//限制范围（当天——2020-12-31）
		count: 		   2,					//日历个数
...
var oBackCal = new Calendar({
		...
		range:		   {mindate: "1980-09-01", maxdate: "2040-12-31"},	//限制范围（当天——2020-12-31）
		count: 		   2,					//日历个数
		monthStep:	   1,					//切换上下月日历步长
		onSelectDate:  fnSelectDate,		//选择日期回调方法
		onClose:	   fnClose				//关闭日历回调方法	
...
oBackCalTime = new Calendar({
		...
		isCalEnd:      !0,					//标记为结束时间
		dateInfoClass: "date-info-end",		//结束时间icon样式
		range:		   {mindate: "1811-09-01", maxdate: "2040-12-31"},	//限制范围（当天——2020-12-31）
		count: 		   1,					//日历个数
		monthStep:	   1,					//切换上下月日历步长
		onSelectDate:  fnSelectDate,		//选择日期回调方法
		onClose:	   fnClose,				//关闭日历回调方法	
...
oBackCalTime1 = new Calendar({
		...
		isCalEnd:      !0,					//标记为结束时间
		dateInfoClass: "date-info-end",		//结束时间icon样式
		range:		   {mindate: "1911-09-01", maxdate: "2040-12-31"},	//限制范围（当天——2020-12-31）
		count: 		   1,					//日历个数
		monthStep:	   1,					//切换上下月日历步长
		onSelectDate:  fnSelectDate,		//选择日期回调方法
		onClose:	   fnClose				//关闭日历回调方法	
