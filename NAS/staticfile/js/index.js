window.addEventListener("load", () => {
    ...
    document.querySelector("#pwd").addEventListener("blur", () => {
        if (state === 1) {
            state = 2;
            document.getElementById("text").innerHTML="<span style=\"color: cyan;\">H</span><span style=\"color: white;\">+</span>";
            coverPosition("80%");
    ...
    document.querySelector("#confirm").addEventListener("focus", () => {
        if (state === 2) {
            state = 1;
            document.getElementById("text").innerHTML="<span style=\"color: cyan;\">捂眼睛</span><br><span style=\"color: white;\">(*/ω＼*)</span>";
            coverPosition("20%");
    ...
    document.querySelector("#confirm").addEventListener("blur", () => {
        if (state === 1) {
            state = 2;
            document.getElementById("text").innerHTML="<span style=\"color: cyan;\">H</span><span style=\"color: white;\">+</span>";
            coverPosition("80%");
